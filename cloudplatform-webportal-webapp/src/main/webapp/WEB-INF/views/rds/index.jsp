    <%@ page language="java" pageEncoding="UTF-8" %>
        ...
        <link rel="stylesheet" href="/stylesheets/dist/common-1465700659110.css">
        <link rel="stylesheet" href="/stylesheets/dist/style-rds-1465700659110.css">
        </head>
        <style>
        .main .side-bar {
        height: 100%;
        ...
        <script type="text/javascript" src="/javascripts/dist/require.min.js" data-main="/javascripts/dist/rds-${lang}-main-build-1465700659110.js"></script>
