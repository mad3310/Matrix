    <%@ page language="java" pageEncoding="UTF-8" %>
        ...
        <link rel="stylesheet" href="/stylesheets/dist/style-rds-1472538362143.css">
        </head>
        <style>
        .main .side-bar {
        height: 100%;
        ...
        <script type="text/javascript" src="/javascripts/dist/require.min.js" data-main="/javascripts/dist/rds-${lang}-main-build-1472538362143.js"></script>
