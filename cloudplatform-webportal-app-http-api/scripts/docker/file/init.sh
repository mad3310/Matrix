...
mkdir webportal-app-http-api
cd webportal-app-http-api
jar -xvf /opt/letv/jetty/webapps/webportal-app-http-api.war
cp /opt/letv/jetty/jetty-web.xml /opt/letv/jetty/webapps/webportal-app-http-api/WEB-INF/
rm -rf /opt/letv/jetty/webapps/webportal-app-http-api.war
