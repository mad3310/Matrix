...
<div class="widget-box widget-color-blue ui-sortable-handle queryOption collapsed">
				...
				<div class="input-group pull-right col-sm-12 col-xs-12 col-md-12">
					<form class="form-inline">
						...
						<div class="form-group col-sm-6 col-xs-12 col-md-2">
							<input type="text" class="form-control" id="containerName" placeholder="ES集群名称">
						</div>
						<div class="form-group col-sm-6 col-xs-12 col-md-2">
		...
		<div class="widget-box widget-color-blue ui-sortable-handle col-xs-12">
			<div class="widget-header">
				<h5 class="widget-title">ES集群列表</h5>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
            				...
            				<h4 class="modal-title">创建ES集群</h4>
            		</div>
					...
					<div class="modal-body">            				
            					<div class="form-group">
										<label class="col-sm-12 col-xs-12 col-md-4 control-label" for="mcluster_name">ES集群名称</label>
...
<script src="${ctx}/static/scripts/pagejs/elasticsearch/cluster_list.js"></script>